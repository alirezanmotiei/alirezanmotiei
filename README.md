...
| :--- | :--- | :--- | :--- |
| **[Digital-Integrated-Circuits-VLSI-HSPICE](https://github.com/alirezanmotiei/Digital-Integrated-Circuits-VLSI-HSPICE)** | Multi-node CMOS VLSI design across 180nm, 90nm, 32nm, and 0.5µm nodes: VTC noise margins, thermal/leakage sweeps (0°C to 100°C), Static CMOS vs DCVSL vs Dynamic NAND3, pipelined memory datapaths, and Tanner L-Edit mask layouts. | `HSPICE` `Tanner L-Edit` `PTM / TSMC 90nm` `LaTeX` | [46-Page Portfolio & IEEE Report](https://github.com/alirezanmotiei/Digital-Integrated-Circuits-VLSI-HSPICE) |
| **[Analog-Integrated-Circuits-Cadence-Virtuoso](https://github.com/alirezanmotiei/Analog-Integrated-Circuits-Cadence-Virtuoso)** | Full-custom analog IC design in TSMC 180nm CMOS: multi-stage Miller op-amp, continuous-time CMFB, PVT corner simulations, physical DRC/LVS mask layout, and analytical small-signal Python verification model. | `Cadence Virtuoso` `Spectre` `TSMC 180nm` `Python` | [Design Portfolio & Reports](https://github.com/alirezanmotiei/Analog-Integrated-Circuits-Cadence-Virtuoso) |
...
| **[profdash-ece](https://github.com/alirezanmotiei/profdash-ece)** | OpenAlex-based ECE/BME faculty importer & venue preset extending profdash (upstream: sahroush/profdash) — faculty research tracking, AI-assisted scoring outreach, and literature profiling. | `Python` `OpenAlex API` `SQLite` `HTMX` | [Source Code](https://github.com/alirezanmotiei/profdash-ece) |
| **[airdrop-alpha](https://github.com/alirezanmotiei/airdrop-alpha)** | Institutional quantitative protocol intelligence engine: on-chain incentive modeling, Sybil-discounted Pareto dilution, and URL heuristic anti-phishing defense. | `Python` `FastAPI` `Pytest` `CI/CD` | [Benchmark & Test Suite (24/24)](https://github.com/alirezanmotiei/airdrop-alpha) |
...
<div align="center">
<sub>Maintained by <a href="https://github.com/alirezanmotiei">Alireza Najafi Motiei</a> · Last updated: 2026</sub>
</div>
