...
| **[profdash-ece](https://github.com/alirezanmotiei/profdash-ece)** | OpenAlex ingestion engine and specialized venue classification presets tailored for ECE/BME academic discovery, faculty research tracking, and automated literature profiling. | `Python` `OpenAlex API` `SQLite` `HTMX` | [Source Code](https://github.com/alirezanmotiei/profdash-ece) |
